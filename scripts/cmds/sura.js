	...
	onStart: async function({api, event, message, args }) {
		...
		async function checkPathExists(filePath) {
			try {
				...
				console.log('ðŸš« The path does not exist ðŸš«');
				return false;
			}
		}
		...
		if (decimalPart === 0) {
				    ...
				    if (audioData) {
					    ...
					    .then((audioArray) => {
						    if (audioArray) {
							    ...
							    let total_line_sms = "ââ”€â”€â² à¦¸à§‚à¦°à¦¾ à¦¨à¦®à§à¦¬à¦°: " + abc_float + " â³â”€â”€â”€â\n" + "ââ”€â”€â² " + part1 + " â³â”€â”€â”€â\n" + "ââ”€â”€â² " + part5 + " â³â”€â”€â”€â\nââ”€â”€â² à¦…à¦¬à¦¤à§€à¦°à§à¦£: " + part4 + " â³â”€â”€â”€â\n";										
							    let body_arrange = "ðŸ’—â•â•â¥âµ—âµ—Ì¥Ì¥ÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥âµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥ÌŠÌŠâ•â•â¥ðŸ’—Ù€" + "\n\n\n" + "â•­â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â—Š\n" + total_line_sms + "\n";									
							    let c = 0;
								typing();
		    ...
		    extractTextAsync(abc_float, decimalPart).then((texts) => {
				...
				let body_arrange = "â¥ÍœÍ¡ð– £ê™°ÙœÙœÙœÙœÙœÙœÙœÙœÙœÌ‹Ì€âš€Ù€Ù°Ù–Ù–Ù–Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù–Ù–Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù°Ù–Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù°Ù°Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù°Ù°Ù°Ù–ÙœÛ¬ ðŸ’—â•â•â¥âµ—âµ—Ì¥Ì¥ÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥âµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠÌŠâµ—Ì¥Ì¥Ì¥Ì¥ÌŠÌŠÌŠâµ—Ì¥Ì¥ÌŠÌŠâ•â•â¥ðŸ’—Ù€Ù°Ù–Ù–Ù–Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù–Ù–Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù°Ù–Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù°Ù°Ù–Ù–ÙœÛ¬Ù€Ù°Ù°Ù°Ù°Ù°Ù–ÙœÛ¬âœÙœÙœÙœÙœÙœÙœÙœÙœÙœÍœÍ¡â¥ê™°" + "\n\n\n" + "â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n" + total_line_sms + "\n" + sura_nombor;
